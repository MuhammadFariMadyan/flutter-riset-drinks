...
part of 'lookupDrinksById.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

LookupDrinksById _$LookupDrinksByIdFromJson(Map<String, dynamic> json) {
  return LookupDrinksById(
    lookupDrinksByIdItems: (json['drinks'] as List)
        ?.map((e) => e == null
            ? null
            : LookupDrinksByIdItem.fromJson(e as Map<String, dynamic>))
        ?.toList(),
  );
}

Map<String, dynamic> _$LookupDrinksByIdToJson(LookupDrinksById instance) =>
    <String, dynamic>{
      'drinks': instance.lookupDrinksByIdItems,
    };

LookupDrinksByIdItem _$LookupDrinksByIdItemFromJson(Map<String, dynamic> json) {
  return LookupDrinksByIdItem(
...
Map<String, dynamic> _$LookupDrinksByIdItemToJson(
        LookupDrinksByIdItem instance) =>
    <String, dynamic>{
