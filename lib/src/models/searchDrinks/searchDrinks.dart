...
part 'searchDrinks.g.dart';

@JsonSerializable()
class SearchDrinks {
  @JsonKey(name: "drinks")
  List<SearchDrinksItem> searchDrinksItems;
  @JsonKey(ignore: true)
  bool isLoading;

  SearchDrinks({this.searchDrinksItems, this.isLoading = false});

  @override
  String toString() {
    return 'SearcDrinks{searchDrinksItems: $searchDrinksItems}';
  }

  factory SearchDrinks.fromJson(Map<String, dynamic> json) => _$SearchDrinksFromJson(json);
...
class SearchDrinksItem {
  ...
  SearchDrinksItem({this.idDrink, this.strDrink, this.strDrinkAlternate,
      this.strCategory, this.strInstructions, this.strDrinkThumb,
      this.strTags, this.strAlcoholic, this.strGlass, this.strIngredient1, this.strIngredient2,
