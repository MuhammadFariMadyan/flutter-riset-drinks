...
part of 'searchDrinks.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

SearchDrinks _$SearchDrinksFromJson(Map<String, dynamic> json) {
  return SearchDrinks(
    searchDrinksItems: (json['drinks'] as List)
        ?.map((e) => e == null
            ? null
            : SearchDrinksItem.fromJson(e as Map<String, dynamic>))
        ?.toList(),
  );
}
...
Map<String, dynamic> _$SearchDrinksToJson(SearchDrinks instance) =>
    <String, dynamic>{
      'drinks': instance.searchDrinksItems,
    };

SearchDrinksItem _$SearchDrinksItemFromJson(Map<String, dynamic> json) {
...
Map<String, dynamic> _$SearchDrinksItemToJson(SearchDrinksItem instance) =>
    <String, dynamic>{
